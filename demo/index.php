<?php include('_header.php'); ?>
  ...
  <main class="layout l-front-page" data-lg-page="home">
      ...
      <div class="h-wrapper">
        <div class="s__inner">
          <div class="s__content" data-lg-reveal="fade">
            ...
            <div class="s__text">
              <a href="#anchor">Lorem ipsum dolor</a> sit amet consectetur adipisicing elit.
          ...
          <div class="s__illustration">
            <div
              data-lg-lottie="/demo/static/lottie/illus.json"
    ...
    <section class="s-lottie">
      <div
      data-lg-lottie="/demo/static/lottie/waaark-v2-5.json"
      data-lg-lottie-loop
      data-lg-lottie-loop-frame="100"
      data-lg-lottie-autoplay></div>
    </section>
    ...
    <section class="section s-parallax">
      ...
      <div
        ...
        data-lg-parallax
        data-lg-parallax-disable="mobile"
    ...
    <section class="section s-sticky">
      <div class="h-wrapper">
        <div id="anchor" class="s__content rte">
